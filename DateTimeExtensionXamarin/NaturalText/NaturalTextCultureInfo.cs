...
using DateTimeExtensionsXamarin.NaturalText.CultureStrategies;

namespace DateTimeExtensionsXamarin.NaturalText
{
        ...
        public Func<string, INaturalTimeStrategy> LocateNaturalTimeStrategy
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    //naturalTimeStrategy = new ES_ESNaturalTimeStrategy(); 
